...
module.exports = {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([{ from: "./src/html/administrator.html", to: "administrator.html" }]),
    ...
    new CopyWebpackPlugin([{ from: "./src/css/index.css", to: "css/index.css" }]),
    new CopyWebpackPlugin([{ from: "./src/css/styles.css", to: "css/styles.css" }]),
    new CopyWebpackPlugin([{ from: "./src/css/admin.css", to: "css/admin.css" }]),
    ...
    new CopyWebpackPlugin([{ from: "./src/images/intro.png", to: "images/intro.png" }]),
    new CopyWebpackPlugin([{ from: "./src/images/Donor-Registration.jpg", to: "images/Donor-Registration.jpg" }]),
    new CopyWebpackPlugin([{ from: "./src/images/patient.svg", to: "images/patient.svg" }]),
    new CopyWebpackPlugin([{ from: "./src/images/administrator.jpg", to: "images/administrator.jpg" }]),
    new CopyWebpackPlugin([{ from: "./src/images/organ-donation-platform-logo.svg", to: "images/organ-donation-platform-logo.svg" }]),
    new CopyWebpackPlugin([{ from: "./src/images/organ-donation-platform-logo-1.png", to: "images/organ-donation-platform-logo-1.png" }]),
    ...
    new CopyWebpackPlugin([{ from: "./src/images/rohit.png", to: "images/rohit.png" }]),
    new CopyWebpackPlugin([{ from: "./src/images/vishvajit.png", to: "images/vishvajit.png" }]),
    new CopyWebpackPlugin([{ from: "./src/images/sanket.png", to: "images/sanket.png" }]),
    new CopyWebpackPlugin([{ from: "./src/images/soumitra.png", to: "images/soumitra.png" }]),  
    new CopyWebpackPlugin([{ from: "./src/images/pledges.png", to: "images/pledges.png" }]), 
